...
<body>
    ...
    <main>
    <section>            
            <button onclick="capturar()" id="botaoCamera">
            ...
            <div class="modal">
                <div class="modal-container">
                    <div id="botao-fechar">
                        <span class="btn-fechar" onclick="botaoFechar()">&times;</span>
                    </div>                    
                    <div id="camera"></div>
                </div>
            </div>            
        ...
        <section>            
            ...
            <form action="" method="post">                
                <input type="number" name="barcode" id="barcode" placeholder="Código de barra" required autocomplete="off" onfocusout="scanFechar()">                                     
